...
public class VisaoAdjunto extends JFrame implements ActionListener {
	...
	public VisaoAdjunto() {
		...
		lMensagem = new JLabel("\t\t\t\t\t\t\t Cadastro Adjunto");
													...
													if (!tfDoutorado.getText().trim().isEmpty()) {
														if (!tfAnoDoutorado.getText().trim().isEmpty()) {
															if (!tfTituloTese.getText().trim().isEmpty()) {
																Executora.professor.cadastraAdjunto(new Adjunto(Integer.parseInt(tfMatriculaSiape.getText()), Integer.parseInt(tfMatriculaFUP.getText()), tfFormacao.getText(), Float.parseFloat(salario), tfGraduacao.getText(), Integer.parseInt(tfAnoGraduacao.getText()), tfMestrado.getText(), Integer.parseInt(tfAnoMestrado.getText()), tfTituloDissertacao.getText(), tfDoutorado.getText(), Integer.parseInt(tfAnoDoutorado.getText()), tfTituloTese.getText()));
